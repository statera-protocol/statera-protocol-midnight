...
// import { StateraAPI, utils } from "@statera/statera-api";
...
//       await StateraAPI.deployStateraContract(walletUtils);
...
//         className="space-y-4"
//       >
//         <h2 className="py-4 font-bold text-slate-400">
//           Deploy new statera contract
//         </h2>
